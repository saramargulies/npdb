...
7/13
started out getting the visited page up and running and then hit a blocker on how to get the delete button to work using redux. Will be following tutorials 
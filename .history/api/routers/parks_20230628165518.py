...
@router.get("/api/parks/{parkCode}", response_model=ListParksOut)
def get_park_by_code(parkCode: str, queries: ParkQueries = Depends()):
    return queries.get_one_by_code(parkCode)

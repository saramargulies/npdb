                    ...
                    <div className="row g-0">
                      ...
                      <div className="col-md-8">
                        <div className="card-body">
                          <h5 className="card-title">         <Link className="link-offset-2 link-underline link-underline-opacity-0 stretched-link" to={`/park/${park.parkCode}`}>{park.fullName}</Link></h5>

              ...
              <div className="card-body">
                ...
                <div className="d-flex flex-row justify-content-start mb-4">
                  ...
                  <div className="p-3 ms-3" style="border-radius: 15px; background-color: rgba(57, 192, 237,.2);">
                    <p className="small mb-0">Hello and thank you htmlFor visiting MDBootstrap. Please click the video
                      below.</p>
                  </div>
                </div>
                ...
                <div className="htmlForm-outline">
                  <textarea className="htmlForm-control" id="textAreaExample" rows="4"></textarea>
                  <label className="htmlForm-label" htmlFor="textAreaExample">Type your message</label>
                </div>

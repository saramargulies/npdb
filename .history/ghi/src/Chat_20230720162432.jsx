      ...
      ="container py-5">
        ...
        ="row d-flex justify-content-center">
          ...
          ="col-md-8 col-lg-6 col-xl-4">
            ...
            <div className
            ="card" id="chat1" style="border-radius: 15px;">
              <div
                className
              ...
              ="card-body">
                ...
                ="d-flex flex-row justify-content-start mb-4">
                  ...
                  <div className
                  ="p-3 ms-3" style="border-radius: 15px; background-color: rgba(57, 192, 237,.2);">
                    <p className
                    ="small mb-0">Hello and thank you for visiting MDBootstrap. Please click the video
                      below.</p>
                  </div>
                </div>
                ...
                ="d-flex flex-row justify-content-end mb-4">
                  <div className
                  ="p-3 me-3 border" style="border-radius: 15px; background-color: #fbfbfb;">
                    <p className
                    ="small mb-0">Thank you, I really like your product.</p>
                  </div>
                ...
                ="form-outline">
                  <textarea className
                  ="form-control" id="textAreaExample" rows="4"></textarea>
                  <label className
                  ="form-label" for="textAreaExample">Type your message</label>
                </div>
